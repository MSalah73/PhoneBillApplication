...
public class PhoneCall extends AbstractPhoneCall implements Comparable<PhoneCall>{
   ...
   */
  private void setPhoneCallData(final String[] phoneCallInformation) throws ParseException {
   ...
   */
  private void validateDateAndTime(String[] phoneCallInformation) throws ParseException {
    ...
    if (!this.startTime.before(this.endTime))
      throw new IllegalArgumentException("Start date and time can not be equals or after the end date and "
