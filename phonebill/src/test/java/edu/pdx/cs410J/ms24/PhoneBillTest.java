...
public class PhoneBillTest {
  ...
  @Test
  public void checkingIfPhoneCallsSortedCorrectlyWithIdenticalPhoneNumbers(){
  ...
  @Test
  public void checkingIfPhoneCallsSortedCorrectlyWithIdenticalStartTime(){
    PhoneBill namedPhoneBill = new PhoneBill("Bad News", validPhoneCall);
  ...
  @Test
  public void checkingIfPhoneCallsSortedCorrectly(){
    PhoneBill namedPhoneBill = new PhoneBill("Bad News", validPhoneCall);
