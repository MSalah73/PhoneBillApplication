...
public class PhoneBillTest {
    ...
    public void addingPhoneCallToEmptyPhoneBillObjectAndCheckIfTheContentIsEqualToObjectInserted(){
        ...
        assertTrue("ValidPhonecall equals object inserted to phonebill object",emptyAndUnnamedPhoneBill.getPhoneCalls().contains(validPhoneCall));
    }
    @Test
    public void addingMultiplePhoneCallToEmptyPhoneBillObjectAndCheckIfTheContentIsEqualToObjectInserted(){
        PhoneCall anotherValidPhoneCall = new PhoneCall(new String[]{"777-222-222","888-888-8888", "2/22/2222", "11:12","3/21/1211", "22:22"});
        emptyAndUnnamedPhoneBill.addPhoneCall(validPhoneCall);
        ...
        assertTrue("ValidPhonecall equals object inserted to phonebill object",emptyAndUnnamedPhoneBill.getPhoneCalls().contains(validPhoneCall));
        assertTrue("ValidPhonecall equals object inserted to phonebill object",emptyAndUnnamedPhoneBill.getPhoneCalls().contains(anotherValidPhoneCall));
    }
    @Test
    ...
    private PhoneCall validPhoneCall = new PhoneCall(new String[]{"999-999-9999","888-888-8888", "2/22/2222", "11:12","3/21/1211", "22:22"});
